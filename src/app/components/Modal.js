    ...
    return(
        <div className="min-h-[280px] w-[500px] rounded-3xl shadow-lg p-6 bg-white">
            ...
            <div className="flex justify-end  space-x-2 mt-8">
                <div className="flex items-center justify-center w-[82px] h-[40px] border-[1px] border-gray-400 rounded-3xl cursor-pointer hover:bg-gray-100">
                    <span className="font-bold text-sm text-gray-500">Cancel</span>
                </div>
                <div className="flex items-center justify-center w-[82px] h-[40px] bg-indigo-600 rounded-3xl cursor-pointer hover:bg-indigo-500">
